      ...
      <div className="container">
        <motion.div className="mx-auto max-w-2xl text-center" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h1 className="font-display text-4xl font-extrabold tracking-tight md:text-5xl">
            About <span className="brand-gradient-text">InternHub</span>
          </h1>
          <p className="mt-5 text-lg text-muted-foreground leading-relaxed">
            InternHub is a skills-based internship platform connecting ambitious students with innovative companies. We make the hiring process smarter, faster, and fairer for everyone.
          </p>
        </motion.div>
      </div>
    </section>
    ...
    <section className="border-t py-20 section-alt">
      <div className="container">
        ...
        <div className="mx-auto mt-8 max-w-2xl space-y-4 text-muted-foreground leading-relaxed">
          <p>Founded in 2026, InternHub was born from a simple observation: the internship search is broken. Students spend countless hours applying to roles that don't match their skills, while companies struggle to find the right talent in a sea of generic resumes.</p>
          ...
          <p>Today, InternHub serves thousands of students and hundreds of companies across industries from fintech to AI, connecting talent with opportunity through technology and thoughtful design.</p>
        </div>
      </div>
    </section>
